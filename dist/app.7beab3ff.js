...
var update = __webpack_require__(1)("1176cee6", content, true, {});
...
// module
exports.push([module.i, "#app[data-v-33f74522],#cover[data-v-33f74522]{position:absolute;left:0;right:0;top:0;bottom:0}#cover[data-v-33f74522]{background-color:#999;opacity:.9;z-index:-1}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("08837ce6", content, true, {});
...
// module
exports.push([module.i, ".main-header[data-v-052a3ff7]{text-align:center}.main-header h1[data-v-052a3ff7]{font-size:100px;color:rgba(175,47,47,.4);font-weight:100;margin:20px}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("67cb8974", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("2aa14c9c", content, true, {});
...
// module
exports.push([module.i, ".todo-item[data-v-8cc55c06]{position:relative;background:#fff;font-size:24px;border-bottom:1px solid rgba(0,0,0,.06)}.todo-item:hover .destroy[data-v-8cc55c06]:after{content:\"x\"}.todo-item label[data-v-8cc55c06]{white-space:pre-line;word-break:break-all;padding:15px 60px 15px 15px;margin-left:45px;display:block;line-height:1.2;transition:color .4s}.todo-item.completed[data-v-8cc55c06]{label:#d9d9d9;text-decoration:line-through}.todo-item .toggle[data-v-8cc55c06]{text-align:center;width:400px;height:40px;position:absolute;top:5px;bottom:0;margin:auto 0;border:none;outline:none;-webkit-appearance:none;-moz-appearance:none;appearance:none}.todo-item .toggle[data-v-8cc55c06]:before{content:url(" + escape(__webpack_require__(28)) + ");position:absolute;left:12px;cursor:pointer}.todo-item .toggle[data-v-8cc55c06]:checked:before{content:url(" + escape(__webpack_require__(29)) + ");position:absolute;left:12px;cursor:pointer}.todo-item .destroy[data-v-8cc55c06]{position:absolute;top:50%;right:10px;bottom:0;width:40px;height:40px;margin:auto 0;font-size:30px;color:#cc9a9a;margin-bottom:11px;transition:color east-out .2s;background-color:transparent;-webkit-appearance:none;-moz-appearance:none;appearance:none;border-width:0;cursor:pointer;outline:none}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("7c23d251", content, true, {});
